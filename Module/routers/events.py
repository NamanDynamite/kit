...
@api_router.post("/event/plan", include_in_schema=False, response_model=ApiResponse)
def plan_event(
    ...
    try:
        ...
        return ApiResponse(status=True, message="Event planned successfully.", data=result)
